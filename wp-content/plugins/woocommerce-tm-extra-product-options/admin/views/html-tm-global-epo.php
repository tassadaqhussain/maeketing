        ...
        <div class="tm_mode_selector">
            ...
            <p class="form-field tm_mode_select">
                <span class="<?php if ( THEMECOMPLETE_EPO()->tm_epo_global_hide_product_builder_mode == "yes" ) {
	                echo 'tm-hidden ';
                } ?>button button-primary button-large tm_select_mode tm_builder_select"><?php esc_html_e( 'BUILDER', 'woocommerce-tm-extra-product-options' ); ?></span>
                <span class="<?php if ( THEMECOMPLETE_EPO()->tm_epo_global_hide_product_normal_mode == "yes" ) {
					echo 'tm-hidden ';
				} ?>button button-primary button-large tm_select_mode tm_local_select"><?php esc_html_e( 'NORMAL', 'woocommerce-tm-extra-product-options' ); ?></span>
                <span class="<?php if ( THEMECOMPLETE_EPO()->tm_epo_global_hide_product_settings == "yes" ) {
					echo 'tm-hidden ';
				} ?>button button-primary button-large tm_select_mode tm_settings_select"><?php esc_html_e( 'SETTINGS', 'woocommerce-tm-extra-product-options' ); ?></span>
            </p>
        </div>
        ...
        <div class="tm_mode_settings tm_options_group woocommerce_options_panel tm_wrapper">
			...
			if ( THEMECOMPLETE_EPO_WPML()->is_original_product( $post_id ) ) {
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'The forms you choose will be displayed alongside with the forms that the product already has.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'This will exclude any global forms assigned to this product except those defined in the previous setting.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				     '<div class="messagexdesc">&nbsp;</div>' .
				     '</div>' .
				     '<div class="message2x2">' .
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'This will override the product price with the price from the options if the total options price is greater then zero.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				     '<div class="messagexdesc">&nbsp;</div>' .
				     '</div>' .
				     '<div class="message2x2">' .
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'This will override the display method only for this product.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				     '<div class="messagexdesc">&nbsp;</div>' .
				     '</div>' .
				     '<div class="message2x2">' .
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'This will override the totals box display only for this product.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				     '<div class="messagexdesc">&nbsp;</div>' .
				     '</div>' .
				     '<div class="message2x2">' .
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'This will override which roles can see the options for this product.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				     '<div class="messagexdesc">&nbsp;</div>' .
				     '</div>' .
				     '<div class="message2x2">' .
				...
				echo '<div class="message0x0 tc-clearfix">' .
				     ...
				     '<span class="woocommerce-help-tip" data-tip="' . esc_attr( esc_html__( 'This will override which roles cannot see the options for this product. This setting has priority over the enabled roles one.', 'woocommerce-tm-extra-product-options' ) ) . '"></span>' .
				     '<div class="messagexdesc">&nbsp;</div>' .
				     '</div>' .
				     '<div class="message2x2">' .
