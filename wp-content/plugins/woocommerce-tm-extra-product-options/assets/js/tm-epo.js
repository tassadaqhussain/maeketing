            ...
            if (showTotal && cartQty > 0) {
                ...
                if (formatted_final_total && product_total_price >= 0) {
                    ...
                    if (TMEPOJS.customer_price_format) {
                        ...
                        _f_regular_price = customerPriceFormat.replace("__CODE__", TMEPOJS.current_currency);
                    ...
                    if (finalTotalBoxMode === "disable_change" || TMEPOJS.tm_epo_change_variation_price === "yes") {
                        if (totalsHolder.data("is-on-sale")) {
                            ...
                            update_native_html.html($.epoAPI.util.decodeHTML($.epoAPI.template.html(tcAPI.templateEngine.tc_formatted_price, {price: _fprice}))).show();
                        }
                    }
                        ...
                        if (!alternativeCart || main_product.find(".cpf-bto-price").length === 0) {
                            if (product_total_price > 0) {
                                if (totalsHolder.data("is-on-sale")) {
                                    ...
                                    $(tcAPI.nativeProductPriceSelector).html($.epoAPI.util.decodeHTML($.epoAPI.template.html(tcAPI.templateEngine.tc_formatted_price, {price: _fprice}))).show();
                                }
                            } else {
