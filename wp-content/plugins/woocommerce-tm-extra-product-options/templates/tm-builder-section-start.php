...
<div data-uniqid="<?php echo esc_attr( $uniqid ); ?>"
     ...
     class="cpf-section tm-row tm-cell <?php echo esc_attr( $column ); ?> <?php echo esc_attr( $sections_class . $tm_product_id_class ); ?>">
	<?php
	...
	if ( isset( $sections_type ) && $sections_type == "popup" ) {
		...
		echo '<a class="tm-section-link" href="#" data-title="' . esc_attr( $_popuplinkitle ) . '" data-sectionid="' . esc_attr( $uniqid ) . '">'
	...
	if ( ( ! empty( $title ) && $title_position != "disable" ) || ( ! empty( $description ) && ( $description_position == "icontooltipright" | $description_position == "icontooltipleft" ) ) ) {
		...
		echo ' class="tm-epo-element-label tm-section-label' . esc_attr( $toggler . $class ) . '">';
