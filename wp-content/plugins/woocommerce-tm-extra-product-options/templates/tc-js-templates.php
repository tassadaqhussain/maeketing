...
<script class="tm-hidden" type="text/template" id="tmpl-tc-formatted-price"><?php echo esc_html($formatted_price); ?></script>
<script class="tm-hidden" type="text/template" id="tmpl-tc-formatted-sale-price"><?php echo esc_html($formatted_sale_price); ?></script>
